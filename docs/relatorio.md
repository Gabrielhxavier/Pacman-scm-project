...
#### Gabriel
- Este projeto foi extremamente importante para aprimorar meus conhecimentos na área de Gerência de Configuração. Embora eu já tivesse tido contato prévio com Git e GitHub em contextos acadêmicos, foi aqui que pude vivenciar, de fato, como é trabalhar em equipe no desenvolvimento colaborativo de software. Os temas abordados em aula — Source Code Management, Build Engineering, Environment Configuration, Change Control, Release Engineering e Deployment — foram essenciais para compreender o cenário real do projeto e aplicar esses conceitos de maneira prática. Em alguns momentos, encontrei desafios por ainda não ter tanta experiência na área, mas, graças à comunicação aberta e à cooperação da equipe, conseguimos superar as dificuldades e construir um trabalho sólido e bem estruturado. No geral, gostei muito da experiência e do aprendizado proporcionado por este projeto!
